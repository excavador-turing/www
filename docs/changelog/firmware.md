...
Newest release **v2.20.0**, 17 in total. Every entry is the release note as published on [GitHub](https://github.com/excavador-turing/BMC-Firmware/releases), fetched by `just refresh-changelog` — not written here, so the two cannot disagree.
