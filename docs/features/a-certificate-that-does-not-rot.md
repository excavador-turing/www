...
<p>The board serves a login page over HTTPS, and on stock firmware that certificate is unusable by any browser made since 2017, expires after thirty days, and is never replaced. This fork fixes all three, adds TLS 1.3, and makes the board say when its certificate is running out.</p>
</div>
