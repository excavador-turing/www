...
This is the argument behind [A certificate that does not rot](../features/a-certificate-that-does-not-rot.md), with the measurements that back it. The feature page is the short version.
