...
This is the argument behind [Updates that undo themselves](../features/updates-that-undo-themselves.md), with the measurements that back it. The feature page is the short version.
...
<div class="tp-next tp-next--argument"><a href="../../features/updates-that-undo-themselves/"><b>Back to the feature →</b><span>The short version: the claim, its numbers and the picture.</span></a><a href="../#demo/fork"><b>See it in the demo →</b><span>The Firmware tab, answering from a real board's data.</span></a><a href="../guides/install/"><b>Do it on your board →</b><span>Install this firmware, and what to read first.</span></a><a href="../reference/gate-history/"><b>The evidence →</b><span>Every decision the gate has made here, read off the board.</span></a><a href="../pick-a-version/"><b>Pick a version, from anywhere →</b><span>Where the image the gate judges comes from.</span></a></div>
