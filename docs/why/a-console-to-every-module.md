...
This is the argument behind [A console to every module](../features/a-console-to-every-module.md), with the measurements that back it. The feature page is the short version.
