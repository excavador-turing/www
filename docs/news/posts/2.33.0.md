---
title: "The board's switch gets VLANs, and the board asks for a password"
date: 2026-09-20
slug: v2.33.0
---

VLANs on the board's own switch, tried before they are kept; a certificate endpoint; and a board still on the factory password now insists you change it before it will do anything else.
...
**Firmware v2.33.0**, 20 September 2026 — the first image to carry [bmcd 2.37.0](../../changelog/bmcd.md), [BMC-UI 3.30.0](../../changelog/bmc-ui.md), [tpi 1.9.0](../../changelog/tpi.md). Every item below is the repository's own changelog entry, taken apart; the whole entry is a click away under each one.
...
- **A renamed board reissues its own certificate.** The self-signed generator reissued on four conditions — no certificate, a mismatched pair, expiry within the renewal window, and never for a certificate it did not issue — and none of them was *the board is not called that any more*.
