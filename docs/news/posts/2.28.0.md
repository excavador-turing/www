...
date: 2026-09-12
slug: v2.28.0
description: "Pins bmcd 2.36.0 and BMC-UI 3.27.0; tpi is unchanged and already current."
image: "captures/access.png"
---

Pins bmcd 2.36.0 and BMC-UI 3.27.0; tpi is unchanged and already current.

<figure class="tp-post-figure" markdown>
![The Access card — who may reach this board, and by which route.](../../assets/captures/access.png){ loading=lazy }
