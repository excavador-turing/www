...
**Firmware v2.28.0**, 12 September 2026 — the first image to carry [bmcd 2.36.0](../../changelog/bmcd.md), [bmcd 2.35.0](../../changelog/bmcd.md), [BMC-UI 3.27.0](../../changelog/bmc-ui.md). Every item below is the repository's own changelog entry, taken apart; the whole entry is a click away under each one.
