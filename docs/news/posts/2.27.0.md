...
**Firmware v2.27.0**, 12 September 2026 — the first image to carry [BMC-UI 3.26.0](../../changelog/bmc-ui.md), [bmcd 2.34.0](../../changelog/bmcd.md), [tpi 1.8.0](../../changelog/tpi.md). Every item below is the repository's own changelog entry, taken apart; the whole entry is a click away under each one.
