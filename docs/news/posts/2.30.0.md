...
**Firmware v2.30.0**, 12 September 2026 — the first image to carry [bmcd 2.36.3](../../changelog/bmcd.md), [bmcd 2.36.2](../../changelog/bmcd.md). Every item below is the repository's own changelog entry, taken apart; the whole entry is a click away under each one.
