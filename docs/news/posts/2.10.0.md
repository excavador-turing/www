...
date: 2026-09-09
slug: v2.10.0
description: "bmcd 2.16.0: every API operation has a path of its own \u2014 GET /api/bmc/thermal, POST /api/bmc/hostname \u2014 over the same dispatcher as the ?opt=&type= form, which\u2026"
---
