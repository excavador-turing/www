...
![The Network tab — the BMC's address beside its name, with the same apply-then-confirm as the switch.](../../assets/captures/news/address.png){ loading=lazy }
...
<figure class="tp-post-figure" markdown>
<video controls muted playsinline preload="none" poster="../../assets/captures/news/address.png" src="../../assets/captures/news/address-apply.mp4"></video>
<figcaption>Recorded in this site's own demo: a static address typed in, applied, and kept only after the page confirms it. Then the same change left alone, so the board puts the old address back by itself.</figcaption>
</figure>
